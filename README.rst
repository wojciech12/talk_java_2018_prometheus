...
Notice: The demo uses Spring 1.x, if you work with Spring 2.x, check `Jedrzej Serwa's project  <https://github.com/jedrzejserwa/micrometer-spring-boot-sandbox>`_.
